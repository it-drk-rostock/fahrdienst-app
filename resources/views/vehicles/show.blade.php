        ...
        <div class="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div class="flex flex-col md:flex-row items-center gap-6 w-full">
                ...
                <div class="flex-1 grid grid-cols-2 md:grid-cols-2 xl:grid-cols-4 gap-4 text-sm md:border-l border-gray-200 md:pl-6 w-full text-center md:text-left">
                    ...
                    <div>
                        <span class="block text-[10px] uppercase text-gray-400 font-bold">Kostenstelle</span>
                        <span class="font-bold text-gray-700">{{ $vehicle->costCenter->code ?? '-' }}</span>
                    </div>
                    <div>
                ...
                <div x-show="showCreateModal" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-60 backdrop-blur-sm px-4" style="display: none;" x-cloak>
                    <div class="bg-white rounded-lg shadow-xl w-full max-w-4xl p-6 max-h-[90vh] overflow-y-auto" @click.away="showCreateModal = false">
                        ...
                        <form action="{{ route('vehicles.damage.store', $vehicle) }}" method="POST" x-data="{ rows: [{ title: '', desc: '', type: 'wear', severity: 'medium' }] }">
                            @csrf
                            <div class="space-y-4">
                                <div class="hidden md:grid grid-cols-12 gap-2 text-xs font-bold text-gray-500 uppercase border-b pb-1"><div class="col-span-3">Bauteil / Titel</div><div class="col-span-4">Beschreibung</div><div class="col-span-2">Art</div><div class="col-span-2">Rep.-Grad</div><div class="col-span-1"></div></div>
